    ...
    def infer(self, evidence, hypothesis=None):
        ...
        try:
            ...
            result = ProbabilisticResult(
                ...
                evidence_strength=len(evidence) if isinstance(evidence, (list, dict)) else 1
            )
...
class ProbabilisticResult:
    ...
    def __init__(self, probability=0.5, confidence=0.5, evidence_strength=0, error=None):
    ...
    def __repr__(self):
        return f"ProbabilisticResult(p={self.probability:.3f}, conf={self.confidence:.3f})"
    ...
    def query(self, node):
        ...
        for parent in node_info["parents"]:
            if parent in self.evidence and parent in self.edges:
                ...
                prob = prob * conditional if parent_evidence else prob * (1 - conditional)
