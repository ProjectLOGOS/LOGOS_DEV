        ...
        for domain_name, domain_config in bijection_data.items():
            if domain_status.get(domain_name, {}).get("available", False):
                ...
                active_domain = {
                    ...
                    "activation_priority": _calculate_activation_priority(domain_config)
                }
        ...
        for key, value in raw_data.items():
            if isinstance(value, dict):
                ...
                for subkey, subvalue in value.items():
                    if subkey not in ["complex_value", "C_value", "mandelbrot_constant", "complex_representation"]:
...
def _check_domain_availability() -> Dict[str, Dict[str, Any]]:
    ...
    try:
        ...
        expected_domains = [
            "ModalPraxis", "GnosiPraxis", "ThemiPraxis", "DynaPraxis", 
            "HexiPraxis", "ChremaPraxis", "MuPraxis", "TychePraxis",
            "AxioPraxis", "ErgoPraxis", "AnthropPraxis", "TeloPraxis",
            "TopoPraxis", "CosmoPraxis", "EthoPraxis", "LogoPraxis",
            "ChronoPraxis", "NumeroPraxis"
        ]
        ...
        for domain_name in expected_domains:
            ...
            possible_paths = [
                logos_intelligence_path / "formal_systems" / f"{domain_name.lower()}.py",
        ...
        return {
            domain: {"available": True, "implementation_path": f"abstract://{domain}", "module_exists": False}
            for domain in [
                "ModalPraxis", "GnosiPraxis", "ThemiPraxis", "DynaPraxis", 
                "HexiPraxis", "ChremaPraxis", "MuPraxis", "TychePraxis"
            ]
...
def _get_default_bijection_mapping() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        "ModalPraxis": {
            ...
            "trinity_weights": {"ethical": 0.3, "gnoseological": 0.5, "teleological": 0.2},
            "mapping_confidence": 0.9
        },
        "GnosiPraxis": {
            "ontological_property": "epistemic_knowledge", 
            "trinity_weights": {"ethical": 0.2, "gnoseological": 0.6, "teleological": 0.2},
            "mapping_confidence": 0.85
        },
        "ThemiPraxis": {
            "ontological_property": "normative_obligation",
            "trinity_weights": {"ethical": 0.6, "gnoseological": 0.2, "teleological": 0.2},
            "mapping_confidence": 0.8
        },
        "DynaPraxis": {
            "ontological_property": "causal_action",
            "trinity_weights": {"ethical": 0.25, "gnoseological": 0.25, "teleological": 0.5},
            "mapping_confidence": 0.75
        },
        "HexiPraxis": {
            "ontological_property": "linguistic_competence",
            "trinity_weights": {"ethical": 0.3, "gnoseological": 0.4, "teleological": 0.3},
            "mapping_confidence": 0.7
        },
        "ChremaPraxis": {
            "ontological_property": "temporal_phase",
            "trinity_weights": {"ethical": 0.2, "gnoseological": 0.3, "teleological": 0.5},
            "mapping_confidence": 0.65
        },
        "MuPraxis": {
            "ontological_property": "recursive_structure",
            "trinity_weights": {"ethical": 0.25, "gnoseological": 0.5, "teleological": 0.25},
