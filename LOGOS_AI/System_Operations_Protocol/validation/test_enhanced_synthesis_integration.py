    ...
    try:
        ...
        adaptive_profile = {
            ...
            "rl_feedback": {
                "avg_regret": 0.2,
                "updates": 15,
                "action_history": ["analyze", "compute", "verify"],
            },
        }
        ...
        trinity_vector = {
            ...
            "trinity_components": {
                "thesis": {
                    "strength": 0.87,
                    "content": "Mathematical analysis reveals complex patterns",
                },
                "antithesis": {
                    "strength": 0.83,
                    "content": "Simple models may be sufficient",
                },
                "synthesis": {
                    "strength": 0.94,
                    "content": "Fractal analysis provides optimal insight",
                },
            },
        ...
        iel_bundle = {
            ...
            "empirical_evidence": {
                "observational_support": 0.79,
                "experimental_validation": 0.83,
            },
            "temporal_context": {"past_relevance": 0.76, "future_implications": 0.88},
            "confidence_metrics": {
                "overall_confidence": 0.83,
                "uncertainty_bounds": [0.77, 0.89],
            },
        }
        ...
        if status["enhanced_capabilities"]["fractal_analysis"]:
            ...
            logger.info(
                f"     ✅ Fractal Enhanced: confidence={fractal_result.confidence_score:.3f}"
            )
            ...
            if hasattr(fractal_result, "fractal_analysis"):
                logger.info(
                    f"     🔬 Fractal analysis available: {fractal_result.fractal_analysis is not None}"
                )
        ...
        if status["enhanced_capabilities"]["symbolic_reasoning"]:
            ...
            assert any(
                term in lambda_result.synthesis_rationale.lower()
                for term in ["lambda", "symbolic", "formal"]
            )

            logger.info(
                f"     ✅ Lambda Symbolic: confidence={lambda_result.confidence_score:.3f}"
            )
            ...
            if hasattr(lambda_result, "lambda_analysis"):
                logger.info(
                    f"     🧮 Lambda analysis available: {lambda_result.lambda_analysis is not None}"
                )
        ...
        test_contexts = [
            (
                "Analyze the fractal patterns in this mathematical system",
                SynthesisMethod.FRACTAL_ENHANCED,
            ),
            ("Prove this theorem using formal logic", SynthesisMethod.LAMBDA_SYMBOLIC),
            (
                "What is the orbital behavior of this complex function?",
                SynthesisMethod.FRACTAL_ENHANCED,
            ),
            (
                "Provide a symbolic representation of this lambda expression",
        ...
        for user_input, expected_method in test_contexts:
            if (
                expected_method == SynthesisMethod.FRACTAL_ENHANCED
                and status["enhanced_capabilities"]["fractal_analysis"]
            ) or (
                expected_method == SynthesisMethod.LAMBDA_SYMBOLIC
                and status["enhanced_capabilities"]["symbolic_reasoning"]
            ):
                ...
                logger.info(
                    f"     🔍 Input: '{user_input[:40]}...' -> Expected: {expected_method.value}"
                )
        ...
        logger.info(
            "🔧 Enhanced components may not be available in current environment"
        )
        return False
    ...
    try:
        ...
        for method in baseline_methods:
            result = synthesizer.synthesize_response(
                synthesis_method=method, **high_quality_inputs
            )
        ...
        for method in enhanced_methods:
            try:
                ...
                logger.info(
                    f"   🚀 Enhanced {method.value}: {result.confidence_score:.3f}"
                )
            except Exception as e:
...
if __name__ == "__main__":
    ...
    async def run_all_tests():
        ...
        if test1 and test2:
            ...
            print(
                "🚀 System now includes advanced mathematical and symbolic reasoning capabilities"
            )
            return True
        else:
