...
def simple_pipeline_test():
    ...
    try:
        ...
        test_input = {
            ...
            "intent_classification": {"primary": "knowledge_synthesis", "confidence": 0.85},
        ...
        lambda_quality = normalized.get('metadata', {}).get('normalization_efficiency', 0.8)  # Default reasonable value
        ...
        translation_quality = translated.get('payload', {}).get('translation_metadata', {}).get('quality_metrics', {}).get('overall_quality', 0.7)
        ...
        step3_ready = tokens.get('payload', {}).get('step3_readiness', {}).get('ready', True)
        print(f"\n=== VALIDATION RESULTS ===")
