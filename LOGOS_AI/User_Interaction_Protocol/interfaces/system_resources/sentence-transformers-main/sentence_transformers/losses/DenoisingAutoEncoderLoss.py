...
class DenoisingAutoEncoderLoss(nn.Module):
    def __init__(
        ...
        self.need_retokenization = not isinstance(
            self.tokenizer_encoder, type(self.tokenizer_decoder)
        )
        ...
        try:
            ...
            raise e
        assert (
            model.transformers_model.config.hidden_size == decoder_config.hidden_size
